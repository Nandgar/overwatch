...
//collect player IDs
$.get("/game.php?t=699570542&village=11300&screen=ally&mode=members_defense", function (membersDef) {
    ...
    playerIDs.forEach(element => {
        urls.push("/game.php?t=699570542&village=11300&screen=ally&mode=members_defense&player_id=" + element)
    });
})
    .done(function () {

        //collect building sharing
        $.get("/game.php?t=699570542&village=11300&screen=ally&mode=members_buildings", function (membersBuildings) {
            ...
            playerBuildingIDs.forEach(element => {
                buildingUrls.push("/game.php?t=699570542&village=11300&screen=ally&mode=members_buildings&player_id=" + element)
            });
        })
            .done(function () {
